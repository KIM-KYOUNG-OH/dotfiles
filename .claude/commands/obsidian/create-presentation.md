...
1. **파일 검색 및 검증**
   ...
   - vault 기본 경로: `~/OneDrive/my-obsidian-vault/`
   - 파일 검색 방법:
     ```bash
     fd -e md "^파일명$" ~/OneDrive/my-obsidian-vault/
     ```
   - 검색 결과 처리:
...
```bash
/obsidian:create-presentation ~/OneDrive/my-obsidian-vault/003-RESOURCES/TDD-Best-Practices.md --duration 60
```
...
1. ~/OneDrive/my-obsidian-vault/003-RESOURCES/TDD-Best-Practices.md
2. ~/OneDrive/my-obsidian-vault/001-INBOX/TDD-Best-Practices.md
