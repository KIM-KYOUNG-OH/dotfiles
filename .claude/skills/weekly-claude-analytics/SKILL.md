...
| 출력 | `~/OneDrive/my-obsidian-vault/analytics/claude-weekly/` |
...
ls ~/OneDrive/my-obsidian-vault/analytics/claude-weekly/${LAST_WEEK}.md 2>/dev/null
```
...
# 출력 디렉토리 생성
mkdir -p ~/OneDrive/my-obsidian-vault/analytics/claude-weekly
```
